                                    ...
                                    <tbody>
                                    	 <?php while($row = $result->fetch_assoc()): ?>
                                    		<tr>
                                                ...
                                                <td> <a href="studentProfile3Edit.php?studentId=<?=$row["studentId"]?>" style="margin-right: 20px;" class="btn btn-info" role="button">Edit</a> <a href="delete3.php?studentId=<?=$row["studentId"]?>" class="btn btn-danger" role="button">Delete</a></td>
                                            </tr>
                                         <?php endwhile; ?>
                                    </tbody>
                               </table>

    ...
    <!-- MAIN SECTION -->
     ...
     <div class="medical-breadcrumb">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <h2 style="font-size: 45px;">Student Year 1</h2>
                    </div>
                     <div class="col-md-3">
                                    	 ...
                                    	 <?php while($row = $result->fetch_assoc()): ?>
                                    		<tr>
                                                ...
                                                <td><a style="font-size: 20px;"><?=$row["studentId"]?></a></td>
                                                  <td> <a href="studentProfile1Edit.php?studentId=<?=$row["studentId"]?>" style="margin-right: 20px;" class="btn btn-info" role="button">Edit</a> <a href="delete1.php?studentId=<?=$row["studentId"]?>" class="btn btn-danger" role="button">Delete</a></td>
                                            </tr>
                                         <?php endwhile; ?>
                                    </tbody>
                               </table>

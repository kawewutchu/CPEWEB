                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a style="font-size: 25px;" href="blog.php">News</a></li>
                            ...
                            <ul class="dropdown-menu">
                                <li class="active" ><a style="font-size: 15px;" href="showYear1.php">Students Year 1</a></li>
                ...
                <div class="col-md-12 margin-btm-40">
                    <div class="row">
                            ...
                            <div class="col-sm-4 margin-btm-30 staff">
                                <tr>
                                  <center>
                                   <a href="studentProfile1.php?studentId=<?=$row["studentId"]?>">
